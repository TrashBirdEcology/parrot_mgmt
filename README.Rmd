...
We have used various search terms to identify potential works of relevance to parrot management. Using various searches (see `parrot_xdd.ipynb`), we identified  __`r parrot_xdd %>% dplyr::select(-filename, -searchterm, -highlight) %>% n_distinct()`__ unique publications. 
